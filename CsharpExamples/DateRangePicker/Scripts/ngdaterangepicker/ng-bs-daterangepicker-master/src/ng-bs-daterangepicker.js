			...
			return {
				...
				link: function($scope, $element, $attributes, ngModel) {
					...
					angular.extend(options,
                        {
                            startDate: $scope.dates.startDate===undefined? moment():((moment.isMoment($scope.dates.startDate)) ? $scope.dates.startDate : $scope.dates.startDate.toDate()),
                            endDate: $scope.dates.startDate === undefined ? moment() : ((moment.isMoment($scope.dates.endDate)) ? $scope.dates.endDate : $scope.dates.endDate.toDate())
                        });
